...
function DeliveryPersonForm() {
    ...
    return (
        <div>
            <Formik
            initialValues={{ role: "DeliveryPerson", firstName: "", lastName: "", nic: "", contactNo: "", drivingLicense: "", email: "", password: "", confPassword: "" }}
            ...
            >
                {({ isSubmitting }) => (
                    <Form>
                        ...
                        <div className="grid grid-cols-4 gap-2">
                        <div className="mb-4">
                                <label htmlFor="text" className="block text-gray-700 text-sm font-bold mb-2">Driving License</label>
                                <Field type="text" name="drivingLicense" className="shadow appearance-none border rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
                                <ErrorMessage name="drivingLicense" component="div" className="text-red-500 text-xs italic" />
                            </div>
                            <div className="mb-4">
